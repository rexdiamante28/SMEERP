  ...
  <div class="modal-dialog <?php if(isset($modal_size)){echo $modal_size;}?>" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><strong>User Record</strong></h4>
      </div>
      <div class="modal-body">
      <?php echo form_open_multipart('users/upload_photo',array('id'=>'upload_image_form','method'=>'post')) ?>
          <div class="col-lg-12 col-md-12 no-padd" style="margin-bottom: 15px;">
            <div class="col-lg-4 col-md-4" style="padding-top: 5px;">
              <label for="subject_desc">User Avatar :</label>
            </div>

            <div class="col-lg-8 col-md-8">
              <input type="file" name="item_image" id="item_image" class="hidden">
              <img id="img_preview" class="img-thumbnail img-responsive col-xs-12 padd-10 point" src="<?= base_url().'assets/images/avatar/user-avatar.jpg'?>" >
      ...
      <?php echo form_open('users/add_user',array('id'=>'add_record_form','method'=>'post')) ?>
        <div class="alert alert-danger hidden" id="error_message">
        
        </div>
        <div class="row">

          <?php $this->load->view('account/users/add_user'); ?>
