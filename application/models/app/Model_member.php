...
class Model_member extends CI_Model {
	...
	{
		$query="select a.id as member_id, concat(a.fname,' ',a.mname,' ',a.lname) as name, a.email, a.mobile_number, b.id as user_id, b.username from 
		 app_members as a left join sys_users as b on a.sys_user = b.id where a.id = ?";

		return $this->db->query($query,$id)->row_array();
	}

	public function read_from_user_id($id)
	{
		$query="select a.id as member_id, concat(a.fname,' ',a.mname,' ',a.lname) as name, a.email, a.mobile_number, b.id as user_id, b.username from 
		 app_members as a left join sys_users as b on a.sys_user = b.id where b.id = ?";
	...
	{
		$query = "select * from app_members where status = '1' ";
