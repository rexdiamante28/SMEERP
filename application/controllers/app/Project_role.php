<?php
class Project_role extends CI_Controller {
	...
	public function list()
	{
		...
		if($this->loginstate->get_access()['overall_access'] == 1)
		{
        	...
        	$result = $this->model_project_role->list($read_args);
        	...
        	$nestedData[] = '
                <button class="btn btn-primary project_role_edit_btn" id="'.en_dec('en',$row['id']).'">Edit</button>
